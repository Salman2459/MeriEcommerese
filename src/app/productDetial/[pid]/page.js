...
const App = () => {
  ...
  let [ProductsIDWala, setProductsIDWala] = useState([])
  let params = useParams()


  useEffect(() => {
    axios.get('https://fakestoreapi.com/products/' + params.pid).then((resp) => {
      setProductsIDWala(resp.data)
    }).catch(() => {
        ...
        <div className="grid items-start grid-cols-1 lg:grid-cols-5 gap-12 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] p-6 rounded-lg">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex flex-wrap gap-4 mt-8">
              <p className="text-gray-800 text-3xl font-bold">${ProductsIDWala.price}</p>
